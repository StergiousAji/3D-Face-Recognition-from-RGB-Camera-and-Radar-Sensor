...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 19 15:47:46 2022
...
f = open('/home/elle/Documents/soli/data/chaitanyaknife1.json')
...
f = open('/home/elle/Documents/soli/data/chaitanyaknife2.json')
json_soli_datas = json.load(f)
json_soli_data.append(json_soli_datas)
...
f = open('/home/elle/Documents/soli/data/chaitanyaknife3.json')
json_soli_datas = json.load(f)
json_soli_data.append(json_soli_datas)

crd_data = []
crd_data.append(get_crd_data(json_soli_data,declutter=False))
crd_resampled_knife3 = np.moveaxis(crd_data[0], 1, -1)
...
f = open('/home/elle/Documents/soli/data/chaitanyanoknife1.json')
json_soli_datas = json.load(f)
json_soli_data.append(json_soli_datas)
...
f = open('/home/elle/Documents/soli/data/chaitanyanoknife2.json')
json_soli_datas = json.load(f)
json_soli_data.append(json_soli_datas)
...
f = open('/home/elle/Documents/soli/data/chaitanyanoknife3.json')
json_soli_datas = json.load(f)
json_soli_data.append(json_soli_datas)

crd_data = []
crd_data.append(get_crd_data(json_soli_data,declutter=False))
crd_resampled_noknife3 = np.moveaxis(crd_data[0], 1, -1)



knife1_label = np.ones((len(crd_resampled_knife1),1), dtype='float32')
knife2_label = np.ones((len(crd_resampled_knife2),1), dtype='float32')
knife3_label = np.ones((len(crd_resampled_knife3),1), dtype='float32')
noknife1_label = np.zeros((len(crd_resampled_noknife1),1), dtype='float32')
noknife2_label = np.zeros((len(crd_resampled_noknife2),1), dtype='float32')
noknife3_label = np.zeros((len(crd_resampled_noknife3),1), dtype='float32')

train = np.abs(np.concatenate((crd_resampled_knife1, crd_resampled_knife2, crd_resampled_noknife1, crd_resampled_noknife2)))
test = np.abs(np.concatenate((crd_resampled_knife3, crd_resampled_noknife3)))

train_label = np.concatenate((knife1_label, knife2_label, noknife1_label, noknife2_label))
test_label = np.concatenate((knife3_label, noknife3_label))
...
model.add(Conv2D(64, (5, 5), activation='relu', input_shape=(64, 16, 3)))
#model.add(Conv2D(128, (3, 3), activation='relu'))
#model.add(MaxPooling2D(2,2))
#model.add(Dense(256, activation='relu', input_shape=(56*8*3,)))
model.add(Flatten())
...
model.fit(train, train_label, batch_size=64, validation_data=(test,test_label), epochs=50, callbacks=callbacks)
