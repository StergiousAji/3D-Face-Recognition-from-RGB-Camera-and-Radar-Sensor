...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  8 16:41:42 2022
...
f = open('/home/chkaul/Desktop/soli/demo-data/Gun_r1/radar.json')
...
images = np.load('/home/chkaul/Desktop/soli/demo-data/Gun_r1/images.npy')
image_timestampss = np.load('/home/chkaul/Desktop/soli/demo-data/Gun_r1/image_timestamps.npy')
...
crd_resampled_gun2 = np.moveaxis(crd_resampled, 1, -1)
images_resampled_gun2 = np.expand_dims(images_resampled, -1)
